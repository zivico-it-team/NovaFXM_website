  ...
  return (
    <div className="w-full overflow-hidden bg-white">
      ...
      <section className="relative flex min-h-[calc(100vh-72px)] w-full items-center justify-center overflow-hidden px-4 py-16 text-center sm:min-h-[calc(100vh-80px)] sm:px-6 lg:min-h-[calc(100vh-84px)]">
        ...
        <div className="relative z-10 max-w-5xl mx-auto market-hero-content">
          <h1 className="text-4xl font-bold text-white market-hero-title sm:text-5xl md:text-6xl lg:text-7xl">
            Indices
          </h1>

          <p className="max-w-3xl mx-auto mt-4 text-sm leading-7 text-gray-200 market-hero-copy sm:mt-6 md:text-lg md:leading-8">
      ...
      <section className="px-4 py-10 mx-auto max-w-7xl sm:px-6 sm:py-12 lg:py-16">
        <div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-12">
          ...
          <div>
            ...
            <div className="grid gap-4 mt-7 sm:grid-cols-2 sm:gap-5">
      ...
      <section className="bg-[#f8faf9] px-4 py-12 sm:px-6 sm:py-16 lg:py-20">
        ...
        <div className="p-3 mx-auto bg-white border border-gray-100 shadow-sm max-w-7xl rounded-2xl sm:rounded-3xl sm:p-6 lg:p-8">
        ...
        <div className="grid grid-cols-1 gap-5 mx-auto mt-10 max-w-7xl sm:grid-cols-2 lg:mt-12 lg:grid-cols-4 lg:gap-6">
          {indices.map((item, index) => (
            <div
              key={index}
              className="p-6 text-center transition bg-white border border-gray-100 shadow-sm rounded-2xl hover:shadow-lg lg:p-7"
            >
      ...
      <section className="px-4 py-12 bg-white sm:px-6 sm:py-16 lg:py-20">
        ...
        <div className="grid items-center gap-6 mx-auto mt-12 max-w-7xl sm:grid-cols-2 lg:mt-16 lg:grid-cols-4 lg:gap-8">
          ...
          {middleCards.map((card, index) => (
            <div
              key={index}
              className="p-6 text-center transition bg-white border border-gray-100 shadow-sm rounded-2xl hover:shadow-lg lg:p-8"
            >
              <div
        ...
        <div className="grid items-center gap-10 mx-auto max-w-7xl lg:grid-cols-3 lg:gap-12">
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:col-span-2 lg:gap-6">
            {factors.map((item, index) => (
              <div
                key={index}
                className="p-6 text-center transition-all duration-300 bg-white border border-gray-100 shadow-sm rounded-2xl hover:shadow-lg lg:p-8"
              >
