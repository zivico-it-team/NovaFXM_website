            ...
            >
              ...
              <div className="flex min-h-[300px] flex-col">
                ...
                <label className="relative flex-1 rounded-md border border-gray-200 bg-white shadow-sm transition focus-within:border-green-600">
                  ...
                  ></textarea>
                  <span className="absolute bottom-4 right-5 text-xs text-gray-500">{charCount} / 1000</span>
                </label>
              </div>

              <div className="md:col-span-2 flex flex-col items-center">
                <label className="flex cursor-pointer items-center gap-3 text-xs text-gray-600" onClick={() => setAgreed((p) => !p)}>
                ...
                <button
                  ...
                  className="mt-5 flex h-14 w-full max-w-md items-center justify-center gap-3 rounded-md bg-green-700 px-8 text-sm font-bold text-white shadow-lg shadow-green-900/15 transition hover:bg-green-800 disabled:opacity-60 disabled:cursor-not-allowed"
                >
                  <Send size={18} />
          ...
          <div className="relative z-10 flex flex-col items-center gap-7 lg:flex-row lg:justify-between">
            <div className="flex flex-col items-center gap-6 text-center sm:flex-row sm:text-left">
              <div className="flex h-28 w-28 shrink-0 items-center justify-center overflow-hidden rounded-full bg-white shadow-lg">
                <img src="/ContacUs 3.PNG" alt="" className="h-full w-full object-cover" />
              </div>
              <div>
                ...
                <p className="mt-3 max-w-md text-sm leading-6 text-gray-600">Our team is ready to assist you with any questions or support you need.</p>
              </div>
            </div>
            <button type="button" onClick={() => navigate("/chatbot")} className="flex h-14 w-full items-center justify-center gap-3 rounded-md bg-yellow-400 px-7 text-sm font-bold text-gray-950 transition hover:bg-yellow-300 sm:w-auto">
