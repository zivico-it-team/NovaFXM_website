  ...
  return (
    <article className="bonus-card reveal-up group relative grid min-h-[260px] overflow-hidden rounded-lg bg-white shadow-[0_8px_22px_rgba(15,23,42,0.14)] ring-1 ring-black/10 md:grid-cols-[1fr_360px]">
      <div className="relative overflow-hidden bg-[linear-gradient(135deg,#004b27_0%,#003d20_42%,#012414_100%)] px-8 py-8 text-white sm:px-12 md:py-10">
        ...
        <span className="relative mb-6 inline-flex items-center gap-2 rounded-full border border-[#014421]/20 bg-[#e9f4e9] px-4 py-1.5 text-xs font-medium text-[#014421]">
          <FaGift className="text-sm text-[#014421]" />
          Promotions
        </span>

        <h2 className="relative text-4xl font-black leading-none tracking-normal text-white sm:text-5xl">
          {promo.title}
        </h2>
        <p className="relative mt-5 max-w-md text-base leading-relaxed text-white/90 sm:text-lg">
          {promo.description}
        </p>
        ...
        <div className="space-y-5">
          {faqs.map((faq, index) => {
            ...
            return (
              <div
                key={faq.question}
                className="overflow-hidden rounded-md bg-white shadow-sm ring-1 ring-black/[0.03]"
              >
                <button
                  type="button"
                ...
                >
                  <span
                    className={`flex w-14 shrink-0 items-center justify-center font-bold ${
                      isOpen
      ...
      <section className="relative flex min-h-[520px] items-center justify-center overflow-hidden bg-black px-4 py-16 text-center text-white sm:px-6 md:min-h-[580px] lg:min-h-[640px]">
        ...
        <div className="relative z-10 w-full max-w-4xl">
          ...
          <h1 className="text-3xl font-extrabold leading-tight text-white sm:text-4xl md:text-6xl">
            ...
            <span className="block text-[#D4AF37] ">With Year-Round Bonuses</span>
          </h1>
          ...
          <button
            className="button-shine mt-8 w-full max-w-[220px] rounded-full bg-[#014421] px-6 py-3 text-sm font-semibold text-white shadow-md transition-all duration-300 ease-out hover:-translate-y-0.5 hover:bg-green-800 hover:shadow-lg hover:shadow-green-900/20 active:translate-y-0 sm:w-auto sm:max-w-none sm:px-8"
            onClick={() => {
