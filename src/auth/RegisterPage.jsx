    ...
    <main className="min-h-screen flex items-center justify-center bg-gray-100 px-4 py-10">
      <section className="auth-card relative w-full max-w-md rounded-2xl bg-white px-6 py-5 text-center shadow-xl sm:px-8">
        ...
        >
          ...
          <button
            type="submit"
            className="w-full rounded-lg bg-green-800 py-2.5 text-sm font-semibold text-white shadow-md transition duration-300 hover:-translate-y-0.5 hover:bg-green-900 hover:shadow-lg active:translate-y-0"
          >
            Sign Up
          </button>
        </form>
